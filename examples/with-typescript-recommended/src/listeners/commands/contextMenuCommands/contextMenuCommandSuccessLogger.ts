...
import { Events, Listener, LogLevel, Command, ContextMenuCommandSuccessPayload } from '@sapphire/framework';
...
export class UserListener extends Listener {
	public run({ interaction, command }: ContextMenuCommandSuccessPayload) {
